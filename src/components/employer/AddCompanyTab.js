...
//                                 id="companyName"
//                                 name="companyName"
//                                 className="border p-2 rounded bg-transparent text-gray-800" // Made transparent
//                             />
    ...
    return (
        <div>
            ...
            >
                {({ values }) => (
                    <Form>
                        {/* Aligning labels and inputs in a row */}
                        <div className="mb-4 flex items-center">
                            ...
                            <Field
                                ...
                                id="companyName"
                                name="companyName"
                                className="border p-2 rounded bg-transparent text-gray-800 w-2/3" // Made transparent
                            />
                        </div>
                        <ErrorMessage name="companyName" component="div" className="text-red-500 mb-4" />

                        <div className="mb-4 flex items-center">
                            <label htmlFor="companyDescription" className="w-1/3">Company Description</label>
                            <Field
                                as="textarea"
                                id="companyDescription"
                                name="companyDescription"
                        ...
                        <ErrorMessage name="companyDescription" component="div" className="text-red-500 mb-4" />

                        <div className="mb-4 flex items-center">
                            <label htmlFor="companySize" className="w-1/3">Company Size</label>
                            <Field
                                type="text"
                                id="companySize"
                                name="companySize"
                        ...
                        <ErrorMessage name="companySize" component="div" className="text-red-500 mb-4" />

                        <div className="mb-4 flex items-center">
                            <label htmlFor="logoURL" className="w-1/3">Company Logo URL</label>
                            <Field
                                type="url"
                                id="logoURL"
                                name="logoURL"
                        ...
                        <ErrorMessage name="logoURL" component="div" className="text-red-500 mb-4" />

                        <div className="mb-4 flex items-center">
                            <label htmlFor="industry" className="w-1/3">Industry</label>
                            <Field
                                type="text"
                                id="industry"
                                name="industry"
                        ...
                        <ErrorMessage name="industry" component="div" className="text-red-500 mb-4" />

                        <div className="mb-4 flex items-center">
                            <label htmlFor="officialWebsite" className="w-1/3">Official Website</label>
                            <Field
                                type="url"
                                id="officialWebsite"
                                name="officialWebsite"
                        ...
                        <ErrorMessage name="officialWebsite" component="div" className="text-red-500 mb-4" />

                        <div className="mb-4 flex items-center">
                            <label htmlFor="diversity" className="w-1/3">Diversity</label>
                            <Field
                                type="text"
                                id="diversity"
                                name="diversity"
                        ...
                        <ErrorMessage name="diversity" component="div" className="text-red-500 mb-4" />

                        <div className="mb-4 flex items-center">
                            <label htmlFor="workplaceCulture" className="w-1/3">Workplace Culture</label>
                            <Field
                                as="textarea"
                                id="workplaceCulture"
                                name="workplaceCulture"
                        ...
                        <ErrorMessage name="workplaceCulture" component="div" className="text-red-500 mb-4" />

                        <div className="mb-4 flex items-center">
                            <label htmlFor="isDisabledFriendly" className="w-1/3">Disabled-Friendly</label>
                            <Field
                                type="checkbox"
                                id="isDisabledFriendly"
                                name="isDisabledFriendly"
